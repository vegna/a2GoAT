...
public:
    ...
    virtual Int_t   FillWeighted(const Double_t x, const Double_t y, const Double_t z, const Double_t weight)                                                                      {return ((GHistScaCor3*)result)->FillWeighted(x, y, z, weight);}

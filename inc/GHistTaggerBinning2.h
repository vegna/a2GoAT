...
public:
    ...
    virtual Int_t           Fill(const Double_t x, const Double_t y, const Int_t taggerChannel, const Int_t taggerTime)       {return ((GHistBGSub3*)array)->Fill(x, y, taggerChannel, taggerTime);}
